...
public class ApiSellOrderRequest {
     ...
     * 收款人银行名称
     */
    @NotNull(payload = BddPayload.MissingParameter.class, message = "currency",groups = {Group1.class})
    private String bank;
     ...
     *微信 支付宝 二维码图片地址
     */
    @NotNull(payload = BddPayload.MissingParameter.class, message = "currency",groups = {Group2.class})
